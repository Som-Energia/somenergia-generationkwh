...
def listMovementsByPartner(cr):
    movements=getAllMovementsLines(cr)
    partner = None
...
cases = genkwh_migratenames.cases = ns.load('scripts/migration_aportacions.yaml')
